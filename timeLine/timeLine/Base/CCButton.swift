...
open class CCButton: UIButton {
    ...
    //是否需要通过改变 view.alpha 透明度的方式来改变点击效果
    open var allowsHighlighted: Bool = false
    ...
    //设置icon/title的方位
    open func updateAlignment(_ __aligment: CCButton.Alignment, _ space:CGFloat = 0.0){
